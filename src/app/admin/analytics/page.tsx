      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="px-4 py-2 bg-white border border-neutral-300 rounded-lg text-sm text-black focus:outline-none focus:border-black transition-colors"
          >
          ...
          <button
            ...
            className="px-4 py-2 bg-transparent border border-neutral-300 text-black rounded-lg text-sm font-medium hover:bg-neutral-100 transition-colors"
          >
            Exportar CSV
          </button>
          <button
          ...
          <button
            onClick={loadAnalytics}
            className="p-2 rounded-lg hover:bg-neutral-100 text-neutral-600 hover:text-black transition-colors"
          >
      ...
      <div className="bg-white border border-neutral-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Object.entries(data.sourceBreakdown).map(([source, count]) => {
            ...
            return (
              <div key={source} className="text-center p-4 bg-neutral-50 border border-neutral-200 rounded-lg">
                <div className="text-3xl font-display font-bold text-black">
                  {count}
                </div>
                <div className="text-sm text-neutral-600 uppercase tracking-wider mt-1">
                  {source}
                </div>
